#### _Brief desc of Project, 11.11.2021_
...
<!-- ![LastCommit](https://img.shields.io/github/last-commit/rkolivashko/wordcounter-csharp)
![Languages](https://img.shields.io/github/languages/top/rkolivashko/wordcounter-csharp)
...
3. Click clone the [repository](https://github.com/rkolivashko/repo.git) from my [GitHub page](https://github.com/rkolivashko) to copy the repository link
...
1. Download and install .NET Core from the [official website](https://dotnet.microsoft.com/download/dotnet-core/)
2. Clone the [repository](https://github.com/rkolivashko) from my [GitHub page](https://github.com/rkolivashko)
...
<!-- _This page may be viewed by cloning the [repository](https://github.com/rkolivashko) from my [GitHub page](https://github.com/rkolivashko) and opening the **index.html** file in any web browser._ -->
...
<!-- _If there are any question or concerns please contact us at our emails: [Roman Kolivashko](mailto:rkolivashko@gmail.com) and [Name](mailto:#). Thank you._ -->
